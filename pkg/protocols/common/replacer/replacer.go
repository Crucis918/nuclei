...
func Replace(template string, values map[string]any) string {
...
func ReplaceOne(template string, key string, value any) string {
...
func replaceOneWithMarkers(template, key string, value any, openMarker, closeMarker string) string {
