...
type WorkflowTemplate struct {
	...
	Tags stringslice.StringSlice `yaml:"tags,omitempty" json:"tags" jsonschema:"title=tags to execute,description=Tags to run template based on"`
	// description: |
...
type Matcher struct {
	...
	Name stringslice.StringSlice `yaml:"name,omitempty" json:"name" jsonschema:"title=name of items to match,description=Name of items to match"`
	// description: |
